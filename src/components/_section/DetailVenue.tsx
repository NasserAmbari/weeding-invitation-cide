...
const DetailVenue = () => {
  return (
    <div className="flex flex-col gap-32 p-8 py-20 justify-center items-center">
      <div className="w-full md:w-[90%] lg:w-[75%] flex flex-col gap-18">
        <div className="flex flex-col md:gap-8">
          ...
          <h4 className="text-3xl md:text-5xl italic text-gray-100">
            <RevealText
              text="2025.10.12"
              trigger="viewport"
              mode="sentence"
        ...
        <div className="flex flex-col">
          ...
          <p className="text-md text-gray-100 text-center italic mt-2">
            <RevealText
